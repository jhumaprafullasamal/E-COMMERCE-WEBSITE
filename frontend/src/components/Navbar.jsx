...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 w-full py-5 z-50 flex items-center justify-between mb-5 px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] font-medium backdrop-blur-lg bg-white/40 border-b border-white/20'>
